...
COURSE_ID = 353100 # CHANGE THIS
ASSIGNMENT_ID = 2035317 # CHANGE THIS
...
if __name__ == '__main__':
    ...
    for i in grades.index:
        ...
        client.upload_programming_submission(COURSE_ID, ASSIGNMENT_ID, grades.loc[i, 'Email Address'], [SID_JSON])
